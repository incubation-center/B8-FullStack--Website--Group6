...
function Poll2() {
  return (
    <div className="poll2 flex flex-col mt-10 ml-10 mr-10 border h-fit bg-white rounded-md">
      ...
      <div className="progress-bar mt-5 ml-5 mr-5">
        <div className="mb-1 text-base font-medium dark:text-white flex justify-between items-center">
          <h1>Solor Korko</h1>
          <h1 className="text-sky-200 font-bold">50%</h1>
        </div>
        ...
        <div className="mb-1 text-base font-medium dark:text-white flex justify-between items-center">
          <h1>Kangkep Boak</h1>
          <h1 className="text-sky-200 font-bold">67%</h1>
        </div>
        <div className="w-full bg-gray-100 rounded-full h-1.5 mb-4 dark:bg-gray-700">
        ...
        <div className="mb-1 text-base font-medium dark:text-white flex justify-between items-center">
          <h1>Khmer Curry</h1>
          <h1 className="text-sky-200 font-bold">70%</h1>
        </div>
        <div className="w-full bg-gray-100 rounded-full h-1.5 mb-4 dark:bg-gray-700">
        ...
        <div className="mb-1 text-base font-medium dark:text-white flex justify-between items-center">
          <h1>Fried Chicken</h1>
          <h1 className="text-sky-200 font-bold">80%</h1>
        </div>
        <div className="w-full bg-gray-100 rounded-full h-1.5 mb-4 dark:bg-gray-700">
