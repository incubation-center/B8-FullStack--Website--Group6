      ...
      <div className=" userChart flex justify-between items-center">
        <div className="User flex relative">
          ...
          <h5 className="text-sm">
            <span className="bottom-2 left-7 absolute w-3 h-3 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
            {createdBy} <br />
            <Moment format='MMMM Do YYYY'>{pollDate}</Moment>
          </h5>
        </div>
