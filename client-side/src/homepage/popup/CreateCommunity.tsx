...
function CreateCommunity() {
  ...
  return (
    <div className="h-screen lg:fixed z-20 lg:inset-0 overflow-y-auto flex items-center justify-center">
      <div
        className="lg:fixed z-20 lg:inset-0 bg-gray-500 opacity-60"
